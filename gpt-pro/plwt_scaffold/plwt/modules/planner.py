...
from .common import SelfAttentionBlock, CrossAttentionBlock, MLP, KinematicIntegrator, assert_rank
...
class PlannerHead(nn.Module):
    def __init__(self, cfg: PLWTConfig):
        ...
        self.decoder = nn.ModuleList(
            [
                ProposalDecoderBlock(D, cfg.planner.num_heads, cfg.visual.dropout)
        ...
        self.reward_head = MLP(D * 2, D * 2, len(cfg.planner.reward_terms), dropout=cfg.visual.dropout)
